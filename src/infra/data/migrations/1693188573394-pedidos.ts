...
export class Pedidos1693188573394 implements MigrationInterface {
  name = 'Pedidos1693188573394';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "pedidos" ("id" SERIAL NOT NULL, "codigoPedido" integer NOT NULL, "precoTotal" integer NOT NULL, "situacao" character varying NOT NULL, "dataHoraCadastro" TIMESTAMP NOT NULL, "clienteId" integer, CONSTRAINT "PK_ebb5680ed29a24efdc586846725" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
